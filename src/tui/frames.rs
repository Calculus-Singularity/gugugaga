...
pub const ALL_VARIANTS: &[&[&str]] = &[&FRAMES_DEFAULT];

/// Duration between animation frames (80 ms ≈ 12.5 FPS, same as Codex).
pub const FRAME_TICK: Duration = Duration::from_millis(80);
